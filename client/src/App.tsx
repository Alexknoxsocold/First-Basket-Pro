...
const WNBAHub = lazy(() => import("@/pages/WNBAHub"));
...
function Router(){return <Suspense fallback={<RouteFallback/>}><Switch><Route path="/signup" component={Signup}/><Route path="/login" component={Login}/><Route path="/invite" component={Invite}/><Route path="/" component={BestPlays}/><Route path="/nba" component={NBA}/><Route path="/wnba/props" component={WNBAProps}/><Route path="/wnba" component={WNBAHub}/><Route path="/nfl" component={NFL}/><Route path="/opening-tips" component={OpeningTips}/><Route path="/player-stats" component={PlayerStats}/><Route path="/team-stats" component={TeamStats}/><Route path="/mlb" component={NRFIPro}/><Route path="/mlb/calibration" component={NRFICalibration}/><Route path="/legal" component={Legal}/><Route path="/admin/mlb-diagnostics" component={AdminMlbDiagnostics}/><Route path="/admin/fb-diagnostics" component={AdminFbDiagnostics}/><Route path="/admin" component={Admin}/><Route component={NotFound}/></Switch></Suspense>}
