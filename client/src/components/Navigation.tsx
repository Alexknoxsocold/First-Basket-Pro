...
export default function Navigation() {
  ...
  return <nav className="site-sports-nav sticky top-14 sm:top-16 z-40 border-b bg-card/92 backdrop-blur-xl supports-[backdrop-filter]:bg-card/80" aria-label="Primary sports navigation">
