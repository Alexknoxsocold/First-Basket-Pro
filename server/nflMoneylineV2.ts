...
export async function modelMoneylineV2(
  ...
  const build=(footballPct:number,odds:number|null,consensus:number|null):NflMoneylineV2Result|null=>{
    ...
    return{
      ...
      reasons:['sportsbook consensus used as market prior','independent team-strength challenger signal','home-field adjustment','uncertainty penalty for model/market disagreement'],
